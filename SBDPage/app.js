...
var $author$project$Main$TeamMembers = {$: 'TeamMembers'};
...
var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$TeamMembers,
			$elm$url$Url$Parser$s('our-members'))
		]));
...
var $author$project$Main$footerView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('All rights reserved (2019)')
				]))
		]));
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Main$aboutUsPage = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$h1,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('AboutUs')
				]))
		]);
};
var $author$project$Main$contactPage = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$h1,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('TeamMembers')
				]))
		]);
};
...
var $author$project$Main$homePage = _List_fromArray(
	[
		A2(
...
var $author$project$Main$projectsPage = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$h1,
...
var $author$project$Main$mainContentView = function (model) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'padding-top', '40vh')
			]),
		function () {
			var _v0 = model.page;
			switch (_v0.$) {
				...
				case 'AboutUs':
					return $author$project$Main$aboutUsPage(model);
				case 'Projects':
					return $author$project$Main$projectsPage(model);
				case 'TeamMembers':
					return $author$project$Main$contactPage(model);
				default:
	...
	return A2(
		...
		A2(
			...
			A3(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Sweaty Bacon Ducks')
					]),
				$rundis$elm_bootstrap$Bootstrap$Navbar$dark(
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'font-family', 'VT323')
					]),
				_List_fromArray(
					[
						$author$project$Main$menuView(model),
						$author$project$Main$mainContentView(model),
